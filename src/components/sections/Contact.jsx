...
export const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        }).catch(() => alert("Sorry, something went wrong. Please email it to me jayglenn.manansala@gmail.com"));
    };
        ...
        <RevealOnScroll>
            <div className="px-4 w-150">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="relative">
                        <textarea id="message" name="message" required row={5} value={formData.message} 
